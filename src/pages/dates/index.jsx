        ...
        <div className="w-screen h-screen flex">
          <div className="flex items-center w-full h-full">
            <div className="w-full h-6/7">
              <div className="h-1/14 w-[100%] flex">
                <button className="flex items-center justify-center border-[.5vh] border-green w-[4%] ml-[4%] h-[7vh] rounded-[2vw] outline-none text-[3vh] text-[#757474]">
                  <div className="rounded-[50%] h-[70%] bg-green w-[60%] flex items-center justify-center text-[3vh]">
                    <AiOutlineArrowLeft />{" "}
                    {/* Poner aquí el URL para el regreso */}
                  </div>
                </button>
                <div className="flex items-center w-[83%] justify-center text-green text-3xl font-semibold">
                  DashBoard
                </div>
              </div>
              <div className="h-1/14 my-[1vh] flex items-center justify-center text-green text-3xl font-semibold">
                ...
                <div className="h-[100%] w-[50%] flex items-center relative justify-end">
                  ...
                  <div
                    className={
                      FilSelect
                        ? "absolute flex flex-col items-center justify-center p-[1vh] top-[12vh] border-[.5vh] border-green rounded-[2vw] mx-[12vw] w-[18vh] h-auto bg-white z-50"
